...
func isCriticalEvent(kind EventKind) bool {
	switch kind {
	case EventError, EventPlanCompleted, EventPlanUpdate, EventProviderRetry, EventToolCall, EventToolResult, EventTaskStarted, EventTaskCompleted, EventMCPComplete, EventApprovalRequired, EventUserInputRequired, EventUserInputDone, EventSessionsListed, EventLocalSubmitResult, EventLocalSubmitDone, EventTurnDone, EventModelPicker, EventPermissionsPicker, EventSkillsMenu, EventSkillsManager, EventPluginsManager, EventReviewMenu, EventSkillLoaded, EventExitRequested, EventClearScreen, EventSessionHydrated:
		return true
	default:
		return false
	}
