...
const CommandsHelp = "/model, /permissions, /agent, /ask [prompt], /plan [prompt], /focus, /review [target], /skills, /plugins, /memory, /new [id], /resume, /clear, /status, /stats, /mcp, /compact, /init, /exit"
